...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div
        class="origin-top-right z-10 absolute top-full left-0 right-auto min-w-56 bg-white border border-slate-200 pt-1.5 rounded shadow-lg overflow-hidden mt-1 {{$align === 'right' ? 'md:left-auto md:right-0' : 'md:left-0 md:right-auto'}}"                
        ...
        x-cloak                
    >
        <div class="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-3">Filters</div>
        <ul class="mb-4">
            <li class="py-1 px-3">
