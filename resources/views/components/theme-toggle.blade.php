<div>
    ...
    <label class="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 rounded-full" for="light-switch">
        ...
        <svg class="w-4 h-4 hidden" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
