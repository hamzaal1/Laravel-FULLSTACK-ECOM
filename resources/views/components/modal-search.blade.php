...
<div x-data="{ searchOpen: false }">
    ...
    >
        <div
            class="bg-white border border-transparent overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
        ...
        >   
            ...
            <form class="border-b border-slate-200">
                <div class="relative">
                    ...
                    <input id="modal-search" class="w-full bg-white border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4" type="search" placeholder="Search Anything…" x-ref="searchInput" />
                    ...
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
                                ...
                                <span><span class="font-medium">Messages</span> - <span class="text-slate-600 group-hover:text-white">Conversation / … / Mike Mills</span></span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
                                ...
                                <span><span class="font-medium">Messages</span> - <span class="text-slate-600 group-hover:text-white">Conversation / … / Eva Patrick</span></span>
                            </a>
                        </li>
                    </ul>
                </div>
